...
CFLAGS = -Wall -pedantic -Wno-unused-function -Wno-deprecated-declarations -O2 -DNDEBUG
...
# LDLIBS = $LDLIBS -L/usr/X11R6/lib -L/usr/local/lib $(lib_fonts_bsd_$(HAVE_LIBFONTS))
